...
<body class="bg-gray-50 text-gray-800 font-sans antialiased flex flex-col min-h-screen selection:bg-primary-500 selection:text-white relative">
    ...
    <header class="fixed top-0 left-0 w-full z-50 transition-all duration-300 shadow-sm border-b" style="border-color: var(--color-primary-200);">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                @if (file_exists(public_path('logo.png')))
                    <img src="{{ asset('logo.png') }}?v={{ time() }}" alt="Logo App" class="w-10 h-10 object-contain drop-shadow-sm">
                @else
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center shadow-inner text-white" style="background-color: var(--color-primary-600);">
