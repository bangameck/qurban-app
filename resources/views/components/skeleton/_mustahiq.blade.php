<div class="animate-pulse w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-[2.5rem] p-6 border border-gray-100 shadow-sm flex flex-col items-center">
            ...
            <div class="h-5 bg-gray-200 rounded-lg w-40 mb-3 text-center"></div>
            <div class="flex justify-center gap-2 mb-8">
                <div class="h-4 bg-gray-100 rounded-full w-24"></div>
            </div>
            
            <div class="w-full bg-gray-50 p-4 rounded-3xl border border-gray-100 flex flex-col gap-3 mb-6">
                <div class="flex justify-between items-center"><div class="h-2 bg-gray-200 rounded w-10"></div><div class="h-2 bg-gray-200 rounded w-16"></div></div>
                <div class="flex justify-between items-center"><div class="h-2 bg-gray-200 rounded w-12"></div><div class="h-2 bg-gray-200 rounded w-14"></div></div>
            </div>

            <div class="w-full h-12 bg-gray-50 rounded-2xl border border-gray-100"></div>
        </div>
        @endfor
    </div>
</div>
