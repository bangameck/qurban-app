<div class="animate-pulse w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-[2.5rem] p-6 border border-gray-100 shadow-sm flex flex-col items-center">
            ...
            <div class="h-5 bg-gray-200 rounded-lg w-40 mb-2"></div>
            <div class="h-3 bg-gray-100 rounded-lg w-24 mb-6"></div>
            ...
            <div class="w-full bg-gray-50 p-4 rounded-3xl border border-gray-100 flex flex-col gap-3 mb-6">
                ...
                <div class="flex justify-between items-center"><div class="h-2 bg-gray-200 rounded w-14"></div><div class="h-2 bg-gray-200 rounded w-18"></div></div>
            </div>
